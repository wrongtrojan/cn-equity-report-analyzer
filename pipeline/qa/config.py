...
def env_str(name: str, default: str | None = None, required: bool = False) -> str | None:
    ...
    if required and (value is None or value == ""):
        raise RuntimeError(
            f"Missing required env: {name}. Set it in {ENV_PATH} or export it in shell."
        )
    return value
